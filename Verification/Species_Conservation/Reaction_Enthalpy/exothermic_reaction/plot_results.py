...
file_path = os.path.join(SCRIPT_DIR, 'exothermic_reaction_summary_01_0001.csv')
results_file_path = os.path.join(SCRIPT_DIR, 'Reaction_Enthalpy_Exo.png')
...
RK = data["004_REACTION_RATE_K( 0.0050_ 0.0000_ 0.0000)"].values #kg.m-3.s-1
S = data["005_QSC( 0.0050_ 0.0000_ 0.0000)"].values


"""
# Species Properties
rho_A = 1430  # kg/m³, Density of reactant 'PVC' (R0(1))
rho_B = 296   # kg/m³, Density of product 'CHAR' (R0(2))
cp_A = 1550.0 # J/kg-K, Specific heat of 'PVC' (C0(1))
cp_B = 1550.0 # J/kg-K, Specific heat of 'CHAR' (C0(2))
...
# Total sensible analytical source term
