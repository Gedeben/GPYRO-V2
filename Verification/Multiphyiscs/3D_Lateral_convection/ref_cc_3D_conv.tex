...
Figure ~\ref{fig:reaction_rate_evolution} illustrates the in-depth propagation of the degradation front and the influence of convective heat losses along the domain boundaries.
