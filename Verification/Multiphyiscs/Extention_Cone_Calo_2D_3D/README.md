...
This verification scenario extends the reference 1D cone calorimeter configuration to two- and three-dimensional (2D and 3D) domains in order to assess the consistency of the numerical solver in multi-dimensional setups.
