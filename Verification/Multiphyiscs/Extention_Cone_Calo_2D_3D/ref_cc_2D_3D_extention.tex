...
To further evaluate the robustness and consistency of the solver, the reference one-dimensional cone calorimeter configuration (See Section \ref{sec:ref_cone_calo}) is extended to two- and three-dimensional domains. The domain is expanded to $10~\mathrm{cm} \times 10~\mathrm{cm}$ in the $x$ and $y$ directions, while maintaining a vertical thickness of $18~\mathrm{mm}$ identical to the 1D case.
