...
\section{Cone Calorimeter Configuration}
\label{sec:ref_cone_calo}
This verification case aims to assess the ability of Gpyro to reproduce a standard one-dimensional pyrolysis scenario representative of cone calorimeter tests, and to compare the results with those from the codes Thermakin and FDS, as detailed in the study~\cite{abdelhafiz2025}.
...
A uniform spatial discretization of 0.02~mm and a time step of 0.05~s are used. Numerical convergence is achived under these settings.
