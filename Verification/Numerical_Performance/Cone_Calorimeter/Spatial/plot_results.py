...
results_file_path1 = os.path.join(SCRIPT_DIR, 'CC_grid_convergence.png')
results_file_path2 = os.path.join(SCRIPT_DIR, 'CC_grid_error.png')
results_file_path3 = os.path.join(SCRIPT_DIR, 'CC_grid_CPU.png')
