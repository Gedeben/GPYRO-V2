...
file_gpyro = os.path.join(SCRIPT_DIR, "heat_conduction_c_summary_01_0001.csv")
results_file_path = os.path.join(SCRIPT_DIR, 'heat_conduction_c_results.png')
...
plt.legend(bbox_to_anchor=(0.43, 0.15), loc='lower left', frameon=False)
plt.tick_params()
plt.tight_layout()
