...
file_gpyro = os.path.join(SCRIPT_DIR, "heat_conduction_a_summary_01_0001.csv")
results_file_path = os.path.join(SCRIPT_DIR, 'heat_conduction_a_results.png')
...
plt.legend(bbox_to_anchor=(0.43, 0.4), loc='lower left', frameon=False)
plt.tick_params()
plt.tight_layout()
