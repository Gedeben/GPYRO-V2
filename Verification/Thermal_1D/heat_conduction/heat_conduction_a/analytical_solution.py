...
def main():
    ...
    k = 0.1  # W/(mK), thermal conductivity
    rho = 100  # kg/m^3, density
    c = 1000  # J/(kgK), specific heat capacity (1 kJ/kgK = 1000 J/kgK)
    h = 100  # W/(m^2K), convective heat transfer coefficient
    ...
    print(f"Calculated parameters for Case A:")
    ...
    time_points = np.linspace(0,2000,200)
