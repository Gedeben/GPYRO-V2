...
results_file_path1 = os.path.join(SCRIPT_DIR, 'O2_Diffusion_hm01.png')
results_file_path2 = os.path.join(SCRIPT_DIR, 'N2_Diffusion_hm01.png')
...
print(f"Max L2 error on YJ={np.round(error_value,4)}")
# Validation check
threshold = 0.002
