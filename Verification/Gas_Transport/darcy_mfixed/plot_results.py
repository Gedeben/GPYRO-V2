...
results_file_path1 = os.path.join(SCRIPT_DIR, 'Viscosity_darcy_mfixed.png')
results_file_path2 = os.path.join(SCRIPT_DIR, 'Pressure_darcy_mfixed.png')
results_file_path3 = os.path.join(SCRIPT_DIR, 'flux_darcy_mfixed.png')
...
P_an=(((P0*Pref)**n+2*alpha*mf*depths/(K))**(1/n))/Pref
