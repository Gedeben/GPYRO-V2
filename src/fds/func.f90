...
WRITE(LU,'(A)') "      ()/)   (()     ((       )    )/(      ()/(    "
WRITE(LU,'(A)') "   /█(▌▌))  (█(███)  (█)    (▌) (████(▖)  (/ ██\\)  "
WRITE(LU,'(A)') "  |█(  __   |█|__)█|  (██\_/█)  |█(__)▌|  |█|  |█|  "
WRITE(LU,'(A)') "  |█( |██|  |█ ███/    \███/    |█████/   |█|  |█|  "
WRITE(LU,'(A)') "  |█(__|█|  |█|         |█|     |█| \█\   |█|__|█|  "
WRITE(LU,'(A)') "   \█████|  |█|          █|     |█|  \█\   \████/   "
WRITE(LU,'(A)') "                                                    "
WRITE(LU,'(A)') "       COUPLED PYROLYSIS / FIRE DYNAMICS MODEL      "
WRITE(LU,'(A)') "                 BASED ON FDS V6.2.0                "
WRITE(LU,'(A)') "                                                    "

!WRITE(LU,'(/A/)')      ' Gpyro / Fire Dynamics Simulator'
!WRITE(LU,'(A,A)')      ' FDS Version      : ',TRIM(VERSION_STRING)
...
WRITE(LU,'(1X,A)') 'https://gitlab.imft.fr/gpyro/gpyro'
WRITE(LU,'(A)')  ""
